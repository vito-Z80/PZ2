...
public class bl_Joystick : MonoBehaviour, IPointerDownHandler, IPointerUpHandler, IDragHandler
{
    ...
    [Header("Settings")]
    [SerializeField, Range(1, 250)]private float Radio;//the ratio of the circumference of the joystick
    ...
    private float radio { get { return (Radio * 1 + Mathf.Abs((diff - CenterReference.position.magnitude))); } }
